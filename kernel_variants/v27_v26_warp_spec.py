"""v27 v26 + warp_specialize on full bwd loops.

Stacks v26's work-ratio gate with `tl.range(..., warp_specialize=True)` on
the full-block loops of both dQ and dK/dV kernels. Backup to v26.
---
...
def _bwd_dkdv_inner(
    ...
    for idx in tl.range(0, n_full, num_stages=3, warp_specialize=True):
