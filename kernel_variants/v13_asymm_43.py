"""v13 asymm_43 — num_stages=(4 full, 3 partial). Isolate the full-increase alone.

v4 = (3, 3), v9 = (4, 2), v12 = (3, 2), v13 = (4, 3). Ablation to separate
the effects of increasing full stages vs decreasing partial stages.
...
def _bwd_dkdv_inner(
    ...
    # Pass 1: full Q-blocks — no mask. v13: num_stages=4.
...
def _bwd_dq_inner(
    ...
    # Pass 1: full K-blocks — no mask. v13: num_stages=4.
    for idx in tl.range(0, n_full, num_stages=4):
