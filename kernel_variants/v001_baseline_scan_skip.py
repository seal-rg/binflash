"""Original BinFlash: scan-and-skip approach (iterate all blocks, check mask).

This is the baseline BinFlash kernel for comparison — it scans through all
N/BLOCK_N positions and checks the block mask before loading K/V.
"""
...
def _binflash_v0_fwd(
    ...
    acc, l_i, m_i = _binflash_v0_fwd_inner(
        acc, l_i, m_i, q,
        K_block_ptr, V_block_ptr, Mask_block_ptr,
