...
# v_acc58: extended autotune for residual correction (extra matmul triggers different config sweet spots)
for _s in [1, 2, 3]:
    for _w in [2, 4, 8]:  # add nw=2
        for _mnr in [None, 128, 168, 192, 224]:  # add 128, 224
            _kw = {}
            if _mnr is not None:
                _kw["maxnreg"] = _mnr
