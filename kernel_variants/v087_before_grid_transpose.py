"""v087 baseline — focused 8-config autotune, grid=(N/BM, B*H).

Before testing transposed grid. Focused autotune: stages=[1-4], warps=[4,8].
Block mask cache. Same kernel as v086_focused_autotune.
"""
