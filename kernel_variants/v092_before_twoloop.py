"""v092 baseline — single-loop scan-and-skip with nested bm_val check.

Single-loop with 3-valued block mask (0=skip, 1=partial, 2=full).
Q pre-scaled by (sm_scale * log2(e)) outside loop. No qk_scale in inner.
Focused autotune: stages=[1-4], warps=[4,8]. Z_TIMES_H in key.
Block mask cache with 3-valued computation. Before two-loop restructure.
"""
