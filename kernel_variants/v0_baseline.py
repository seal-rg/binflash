"""v0 baseline — self-contained bwd snapshot. Forward is v270 production; backward is the initial F2-style kernel with no block-skipping."""
...
def _binflash_bwd(do, q, k, v, o, lse, mask, sm_scale):
    ...
    # D=64 can afford more pipelining.
