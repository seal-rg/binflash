"""v084 baseline — scan-and-skip + block mask cache, before bit-packed mask attempt.

Same kernel as v081_blockmask_cache: bool block mask, 20-config autotune, cache.
"""
