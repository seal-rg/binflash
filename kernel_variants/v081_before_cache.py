"""v081 baseline — same as v078 production kernel, before adding block mask cache.

Single kernel: scan-and-skip with bool block mask. No cache. 20-config autotune.
"""
