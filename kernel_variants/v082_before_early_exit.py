"""v082 baseline — production kernel with block mask cache, before early exit.

Scan-and-skip with bool block mask + single-entry cache. 20-config autotune.
Same kernel as v081_blockmask_cache.
"""
