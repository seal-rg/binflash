"""v2b dkdv_cached — v2 + per-mask autograd-path preproc cache.
Isolates the caching effect from kernel-structural changes in v4.
Kernels are IDENTICAL to v2; only the Python entry caches."""
...
# v2b: per-mask cache for the autograd path (fwd + bwd preproc).
_ag_cache_key = None
_ag_cache_val = None
