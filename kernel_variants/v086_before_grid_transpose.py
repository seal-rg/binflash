"""v086 baseline — focused 8-config autotune + cache, grid=(N/BM, B*H).

Before testing transposed grid for L2 K/V reuse.
Focused autotune: stages=[1-4], warps=[4,8] (8 configs, removed never-optimal warps=2,16).
"""
