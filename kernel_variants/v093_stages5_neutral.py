"""v093: Added stages=5 to autotune — NEUTRAL. Autotuner picks it when beneficial.

Two-loop scan with stages=[1-5], warps=[4,8] (10 configs).
Same as production kernel in binflash_attention.py.
"""
