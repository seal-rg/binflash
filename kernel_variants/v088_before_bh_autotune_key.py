"""v088 baseline — autotune key=["N_CTX", "HEAD_DIM"], before adding batch-head info.

Focused 8-config autotune: stages=[1-4], warps=[4,8]. Block mask cache.
Same kernel as v086_focused_autotune / v087_before_grid_transpose.
"""
